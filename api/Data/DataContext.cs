        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1, "Lauro", "Ignacio"),
                    new Professor(2, "Roberto", "Staziak"),
                    new Professor(3, "Ronaldo", "Munhos"),
                    new Professor(4, "Rodrigo", "Diament"),
                    new Professor(5, "Alexandre", "Medeiros"),
                });
